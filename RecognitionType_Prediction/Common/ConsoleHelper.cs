...
namespace Common
{
    public static class ConsoleHelper
    {
        ...
        public static void PrintRegressionPredictionVersusObserved(string predictionCount, string predictionID, string observedCount, string observedID)
        {
            Console.WriteLine($"-------------------------------------------------");
            Console.WriteLine($"Predicted Count:    {predictionCount}");
            Console.WriteLine($"Predicted ID:       {predictionID}");
            Console.WriteLine($"Actual Count:       {observedCount}");
            Console.WriteLine($"Actual ID:          {observedID}");
            Console.WriteLine($"-------------------------------------------------");
        }
